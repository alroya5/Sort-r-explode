...
class Pink {
    constructor(initialPosition) {
        ...
        this.rotation = 0;
        this.image = graphicAssets.ball.image;
        this.body = null;
        this.speed = 0;
        this.direction = 0;
        this.moving = false;
    ...
    Draw(ctx) {
        ...
        ctx.drawImage(this.image, 150, 261, 40, 40, -23, -24,50, 50);
    ...
    MouseUp(event) {
         ...
         if(this.IsMouseOver(mousePos))
        {
            ...
            if (LeftWallSensor.GetFixtureList().TestPoint(this.body.GetPosition())) {
                
               this.draggable = false;
               this.remove = true;   
           }
           else if(RightWallSensor.GetFixtureList().TestPoint(this.body.GetPosition()))
           {
                Reset();
           }
